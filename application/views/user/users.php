                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-button-action">
                                            <a type="button" href="<?= site_url("auth/delete_user/" . $user->id); ?>" data-toggle="tooltip" onclick="return confirm('Are you sure you want to delete this user?');" class="btn btn-link btn-danger mt-1" data-original-title="Remove">
