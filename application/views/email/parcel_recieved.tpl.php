                                                                ...
                                                                <tr>
                                                                    <td class="esd-container-frame" width="530" valign="top" align="center">
                                                                        <table width="100%" cellspacing="0" cellpadding="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td class="esd-block-image es-p25t es-p25b es-p35r es-p35l" align="center" style="font-size:0"><a target="_blank" href="#"><img src="https://cdn1.iconfinder.com/data/icons/youtuber/256/thumbs-up-like-gesture-512.png" alt style="display: block;" width="120"></a></td>
                                                                                </tr>
                                                                                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p20b" align="center">
                                                                                        <p style="font-size: 16px; color: #777777;">Your order has been delivered. You can buy any products at your time!</p>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p15t es-p20b" align="center">
                                                                                        <p style="font-size: 16px; color: #777777;">Thank you for doing business with us!</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
