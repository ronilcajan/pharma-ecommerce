            ...
            <div class="modal-body">
                <form method="POST" action="<?= site_url('settings/save_settings') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-floating-label">
                        ...
                        <input type="text" class="form-control" name="number" value="<?= $sys->number ?>">
                    </div>
                    <div class="form-group form-floating-label">
                        <label>Email Address</label>
                        <input type="text" class="form-control" name="email" value="<?= $sys->email ?>">
                    </div>
                    <div class="form-group form-floating-label">
                        <label>Address</label>
                        <textarea class="form-control" name="address"><?= $sys->address ?></textarea>
                    </div>
                    <div class="form-group form-floating-label">
                        <label>About Us</label>
                        <textarea class="form-control" name="about"><?= $sys->about ?></textarea>
                    </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
