...
class Settings extends CI_Controller
{
    ...
    public function save_settings()
    {
        ...
        if ($this->ion_auth->is_admin()) {
            ...
            $this->form_validation->set_rules('number', 'System Number', 'required|trim');
            $this->form_validation->set_rules('email', 'System Email', 'required|trim');
            $this->form_validation->set_rules('address', 'System Address', 'required|trim');
